...
function mockInvoke<T>(cmd: string, args?: any): T {
  switch (cmd) {
    case "scan_tools": return [
      { id: "chatgptdesktop", name: "ChatGPT", category: "桌面端", is_installed: true, install_path: "C:\Program Files\ChatGPT\ChatGPT.exe", config_path: null, api_protocols: ["openai"], has_config: false, sync_supported: false, launch_uri: "shell:AppsFolder\OpenAI.Codex_2p2nqsd0c76g0!App" },
      ...
      { id: "hermes", name: "Hermes", category: "桌面端", is_installed: true, install_path: "C:\Program Files\Hermes\Hermes.exe", config_path: null, api_protocols: ["openai"], has_config: false, sync_supported: false, launch_uri: null },
      { id: "opencode", name: "OpenCode", category: "桌面端", is_installed: false, install_path: null, config_path: null, api_protocols: ["openai"], has_config: false, sync_supported: false, launch_uri: null },
  ...
  { internalId: "ollama-llama3", name: "Ollama", modelId: "llama3", baseUrl: "http://localhost:11434/v1", apiKey: "", anthropicUrl: null, type: "openai" },
    ...
    case "launch_tool": return "Tool launched successfully (mock)" as any;
