...
description: >
  ...
  are identical and sacred — the dark tech canvas, a single saturated cobalt (#1e2bfa) as the only
...
colors:
  ...
  accent-medium: "rgba(124, 58, 237, 0.20)"
  border: "rgba(0, 212, 255, 0.25)"
  card-bg: "rgba(0, 212, 255, 0.06)"
  positive: "#059669"
  negative: "#ef4444"
...
commitment.** A dark tech canvas and a single saturated cobalt that carries every accent —
...
- **dark tech ground** on every frame; **single cobalt** as the only accent.
...
- Start every frame on **dark tech**; let **cobalt carry every accent** (eyebrow, numeral, CTA, bar, progress).
